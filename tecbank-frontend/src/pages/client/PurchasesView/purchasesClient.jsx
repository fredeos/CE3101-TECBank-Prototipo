...
function CardPurchases() {
    ...
    const handleExport = () => {
        ...
        description: "Sus datos de compras están siendo exportados a CSV.",
        })
    }
    ...
    return (
        ...
        <div className="purchases-content">
            ...
            <div className="filters-section">
                ...
                <Button variant="outline" size="sm" onClick={handleExport} className="export-button">
                ...
                <div className="filter-group">
                    <Label htmlFor="cardSelect" className="filter-label">
                    <CreditCard className="filter-label-icon" />
                    Seleccionar Tarjeta
                    </Label>
                    <Select value={selectedCardId} onValueChange={setSelectedCardId}>
                    <SelectTrigger id="cardSelect" className="filter-select">
                ...
                <div className="filter-group">
                    ...
                    <SelectTrigger id="categoryFilter" className="filter-select">
                ...
                <div className="search-input-container">
                    ...
                    <Input
                    type="search"
                    placeholder="Buscar por comerciante o categoría..."
                    value={searchTerm}
            ...
            <div className="results-section">
                ...
                <h3 className="results-title">
                    {sortedPurchases.length} {sortedPurchases.length === 1 ? "Compra" : "Compras"} Encontradas
                </h3>
                {sortedPurchases.length > 0 && (
                    <p className="results-total">
                    Total: <span className="results-total-amount">${totalAmount.toFixed(2)}</span>
                    </p>
                )}
                </div>
                        ...
                        return (
                            ...
                            <TableCell className="status-cell">
                                ...
                                className={`status-badge ${
                                    purchase.status === "pending" ? "status-pending" : "status-posted"
                                }`}
                                >
